...
(deftest credential-screen-never-auto-at-any-phase
  (testing "screening carries no direct clinical risk, but is still never auto-eligible, matching every sibling KYC/conflict/independence/surveillance/calibration/credential/integrity/patron screen"
    (doseq [[n {:keys [auto]}] phase/phases]
...
(deftest phase-3-auto-commits-only-no-capital-risk-ops
  (testing ":case/intake carries no direct clinical risk -- auto-eligible; it is the ONLY auto-eligible op in this domain"
